...
<c:url var="vendorRead" value="/vendor/list" />
...
.k-link, tr {
	...
	<br>
	<p />
	<kendo:grid title="회사리스트" name="vendorGrid" pageable="true"
		sortable="true" scrollable="true" height="320px" filterable="true"
		groupable="true" change="onChange">
		...
		<kendo:dataSource pageSize="20" batch="true">
			<kendo:dataSource-transport>
				<kendo:dataSource-transport-read url="${vendorRead}" dataType="json"
